...
// in netscope/test/traceroute-map-features/map_screen_test.dart.
...
class _FakeClient_20 extends _i1.SmartFake implements _i8.Client {
  _FakeClient_20(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
/// A class which mocks [TraceRouteService].
///
/// See the documentation for Mockito's code generation for more information.
class MockTraceRouteService extends _i1.Mock implements _i11.TraceRouteService {
  MockTraceRouteService() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i5.Future<String> getDeviceIpAddress() => (super.noSuchMethod(
        Invocation.method(
          #getDeviceIpAddress,
          [],
        ),
  ...
  @override
  _i5.Future<Map<String, dynamic>> getGeolocation(String? ipAddress) =>
      (super.noSuchMethod(
        Invocation.method(
          #getGeolocation,
          [ipAddress],
  ...
  @override
  _i5.Future<int> pingIpAddress(String? ipAddress) => (super.noSuchMethod(
        Invocation.method(
          #pingIpAddress,
          [ipAddress],
        ),
  ...
  @override
  _i5.Future<List<_i11.TracerouteResult>> trace() => (super.noSuchMethod(
        Invocation.method(
          #trace,
          [],
        ),
        returnValue: _i5.Future<List<_i11.TracerouteResult>>.value(
            <_i11.TracerouteResult>[]),
      ) as _i5.Future<List<_i11.TracerouteResult>>);

  @override
  String extractIpAddress(String? host) => (super.noSuchMethod(
        Invocation.method(
          #extractIpAddress,
          [host],
        ),
